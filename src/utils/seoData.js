...
export const SEO = {
  ...
  wishlist: { title: "Список бажань — My Shop", description: "" },
  profile: { title: "Профіль — My Shop", description: "" },
  faq: { title: "FAQ — My Shop", description: "Часті питання та відповіді" },
  notFound: { title: "404 — Сторінку не знайдено", description: "" },
};
